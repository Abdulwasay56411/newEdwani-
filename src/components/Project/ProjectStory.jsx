    ...
    <div className="flex flex-col xl:flex-row items-center justify-center px-6 md:px-10 lg:px-20 gap-12 md:gap-16 lg:gap-32">
      ...
      <div className="relative w-full lg:w-[659px] flex-shrink-0 mt-8 lg:mt-0 xl:order-1">
        ...
        <div className="relative w-full sm:w-[90%] lg:w-[458px] mx-auto rounded-[37px]">
          ...
          <img
            className="w-36 sm:w-44 md:w-52 h-36 sm:h-44 md:h-52 absolute -top-2 right-0 rounded-[37px] outline-[8px] sm:outline-[12px] md:outline-[14px] outline-gray-50"
            src="/services1.png"
      ...
      <div className="flex flex-col w-full lg:w-1/2 justify-center items-start gap-4 md:gap-6 lg:gap-8 xl:order-2">
        ...
        <p className="text-[16px] sm:text-[18px] lg:text-[20.44px]">
         ...
         Successful completion of building and road projects across
          multiple  regions in Saudi Arabia since 1990.
        </p>
        <p className="text-[16px] sm:text-[18px] lg:text-[20.44px]">
          <span className="font-semibold">End-to-End Expertise -</span> From 
           site preparation and excavation to construction and finishing,
          we manage projects with precision and efficiency.
        </p>
        <p className="text-[16px] sm:text-[18px] lg:text-[20.44px]">
         <span className="font-semibold">Quality That Lasts -</span>{" "}
          Every project is built on strong foundations, strict safety
          standards, and modern techniques to ensure durability and
          trust.
        </p>
      </div>
    </div>
